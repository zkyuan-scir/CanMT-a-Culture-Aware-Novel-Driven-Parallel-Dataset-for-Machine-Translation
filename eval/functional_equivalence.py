#!/usr/bin/env python3
"""Evaluate Functional Equivalence for translation outputs."""
...
DIMENSION = "Functional_Equivalence"
...
Examine whether the translation achieves the function of the {src_lang} sentence, such as providing information, expressing criticism, persuading, or evoking emotions. Infer the function intended by the original author, then assess whether the translation realizes it.

### 2. Scoring Rubric (1-7)
1: The translation utterly fails to achieve the source's intended function.
2: The translation achieves minimal functional equivalence, with major failures in conveying purpose or emotion.
3: The translation partially realizes the source function but has significant shortcomings.
4: The translation adequately fulfills the basic function, though not fully effectively.
5: The translation mostly achieves the source function, with good conveyance of intended effects.
6: The translation effectively realizes the source function and desired reader response.
7: The translation perfectly captures and enhances all intended functions of the source.
