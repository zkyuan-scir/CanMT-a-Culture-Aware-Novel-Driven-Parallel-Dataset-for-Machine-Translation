#!/usr/bin/env python3
"""Evaluate Fidelity for translation outputs."""
...
def prompt_build(query: dict[str, Any]) -> str:
    ...
    criterion = f"""
### 1. Fidelity
Assess whether the translation maximally retains the literal meaning, core informational content, and source-language structure of the original text. This dimension is about informational transfer, not style, tone, or communicative effect.

### 2. Scoring Rubric (1-7)
1: The translation severely deviates from the source meaning and structure, with extensive errors, omissions, or semantic loss.
2: The translation shows major deviations, inaccuracies, or unnecessary changes.
3: The translation retains some literal elements but contains notable errors or omissions.
4: The translation basically preserves source meaning and structure, with minor deviations or omissions.
5: The translation mostly maintains high fidelity, with few minor issues.
6: The translation effectively preserves source meaning and structure with almost no semantic loss.
7: The translation impeccably retains every aspect of the source's literal meaning and structure.
